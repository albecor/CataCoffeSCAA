...
$(function(){
	  $('#${param.idChart}').radarChart({
	    size: [600, 500],
	    step: 1,
	    title: "My Skills",
	    values: {
	      '<spring:message code="fragrance" /> ${requestScope.sample.code}': 4,
	      '<spring:message code="flavor" /> ${requestScope.sample.code}': 4,
	      '<spring:message code="acidity" /> ${requestScope.sample.code}': 7.9,
	      '<spring:message code="body" /> ${requestScope.sample.code}': 4,
	      '<spring:message code="residualFlavor" /> ${requestScope.sample.code}': 4,
	      '<spring:message code="balance" /> ${requestScope.sample.code}': 4,
	      '<spring:message code="sweetness" /> ${requestScope.sample.code}': 4,
	      '<spring:message code="tasterScore" /> ${requestScope.sample.code}': 4,
